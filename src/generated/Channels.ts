 ...
 * @secure
 */
channelsControllerCreate = (session: any, data: CreateChannelRequest, params: RequestParams = {}) =>
    this.request<Channel, any>({
        path: `/api/${session}/channels`,
        method: 'POST',
 ...
 * @secure
 */
channelsControllerSearchByView = (session: any, data: ChannelSearchByView, params: RequestParams = {}) =>
 ...
 * @secure
 */
channelsControllerSearchByText = (session: any, data: ChannelSearchByText, params: RequestParams = {}) =>
    this.request<ChannelListResult, any>({
