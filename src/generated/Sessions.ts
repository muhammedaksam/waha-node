 ...
 * @secure
 */
sessionsControllerUpdate = (session: any, data: SessionUpdateRequest, params: RequestParams = {}) =>
    this.request<SessionDTO, any>({
        path: `/api/sessions/${session}`,
        method: 'PUT',
                body: data,        secure: true,        type: ContentType.Json,        format: "json",        ...params,
 ...
 * @secure
 */
sessionsControllerDepracatedStart = (data: SessionStartDeprecatedRequest, params: RequestParams = {}) =>
    this.request<SessionDTO, any>({
 ...
 * @secure
 */
sessionsControllerDeprecatedStop = (data: SessionStopDeprecatedRequest, params: RequestParams = {}) =>
    this.request<void, any>({
 ...
 * @secure
 */
sessionsControllerDeprecatedLogout = (data: SessionLogoutDeprecatedRequest, params: RequestParams = {}) =>
    this.request<void, any>({
