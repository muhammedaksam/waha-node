 ...
 * @secure
 */
chatsControllerPostChatsOverview = (session: any, data: OverviewBodyRequest, params: RequestParams = {}) =>
    this.request<(ChatSummary)[], any>({
        path: `/api/${session}/chats/overview`,
        method: 'POST',
 ...
 * @secure
 */
chatsControllerDeleteMessage = (session: any, chatId: string, messageId: string, params: RequestParams = {}) =>
    this.request<void, any>({
        path: `/api/${session}/chats/${chatId}/messages/${messageId}`,
        method: 'DELETE',
                        secure: true,                        ...params,
 ...
 * @secure
 */
chatsControllerEditMessage = (session: any, chatId: string, messageId: string, data: EditMessageRequest, params: RequestParams = {}) =>
    this.request<void, any>({
        path: `/api/${session}/chats/${chatId}/messages/${messageId}`,
        method: 'PUT',
 ...
 * @secure
 */
chatsControllerPinMessage = (session: any, chatId: string, messageId: string, data: PinMessageRequest, params: RequestParams = {}) =>
    this.request<void, any>({
 ...
 * @secure
 */
chatsControllerUnpinMessage = (session: any, chatId: string, messageId: string, params: RequestParams = {}) =>
    this.request<void, any>({
