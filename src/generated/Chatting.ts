 ...
 * @secure
 */
chattingControllerSendLinkCustomPreview = (data: MessageLinkCustomPreviewRequest, params: RequestParams = {}) =>
    this.request<object, any>({
 ...
 * @secure
 */
chattingControllerSendContactVcard = (data: MessageContactVcardRequest, params: RequestParams = {}) =>
    this.request<void, any>({
 ...
 * @secure
 */
chattingControllerSendLinkPreviewDeprecated = (data: MessageLinkPreviewRequest, params: RequestParams = {}) =>
    this.request<void, any>({
