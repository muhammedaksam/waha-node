 ...
 * @secure
 */
mediaControllerConvertVoice = (session: any, data: VoiceFileDTO, params: RequestParams = {}) =>
 ...
 * @secure
 */
mediaControllerConvertVideo = (session: any, data: VideoFileDTO, params: RequestParams = {}) =>
    this.request<File, any>({
