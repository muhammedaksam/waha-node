 ...
 * @secure
 */
labelsControllerUpdate = (session: any, labelId: string, data: LabelBody, params: RequestParams = {}) =>
    this.request<Label, any>({
 ...
 * @secure
 */
labelsControllerPutChatLabels = (session: any, chatId: string, data: SetLabelsRequest, params: RequestParams = {}) =>
