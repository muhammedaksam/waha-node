 ...
 * @secure
 */
profileControllerSetProfileName = (session: any, data: ProfileNameRequest, params: RequestParams = {}) =>
 ...
 * @secure
 */
profileControllerSetProfileStatus = (session: any, data: ProfileStatusRequest, params: RequestParams = {}) =>
    this.request<Result, any>({
 ...
 * @secure
 */
profileControllerSetProfilePicture = (session: any, data: ProfilePictureRequest, params: RequestParams = {}) =>
    this.request<Result, any>({
